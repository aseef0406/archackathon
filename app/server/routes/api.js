...
module.exports = function(router) {
  ...
  router.put('/users/:id/idea', isOwnerOrAdmin, function(req, res){
    var idea = req.body.idea;
    var id = req.params.id;

    UserController.updateIdeaById(id, idea , defaultResponse(req, res));
  });
  ...
  router.get('/users/:id/team', isOwnerOrAdmin, function(req, res){
    ...
    UserController.getTeammates(id,teamname, defaultResponse(req, res));
  });
  router.get('/users/:id/idea', isOwnerOrAdmin, function(req, res){
    var id = req.params.id;
    UserController.getIdeas(id, defaultResponse(req, res));
  });
  router.get('/users/:id/email', isOwnerOrAdmin, function(req, res){
    var id = req.params.id;
    UserController.getEmails(id, defaultResponse(req, res));
  });
  /**
  ...
  router.put('/users/:id/setteam', isOwnerOrAdmin, function(req, res){
    var parameters = req.body.parameters;
    var id = req.params.id;
    console.log(req.body);
    UserController.setTeamName(id, parameters, defaultResponse(req, res));

  });
  router.put('/users/:id/userbyemail', isOwnerOrAdmin, function(req, res){
    var email = req.body.email;
    var id = req.params.id;
    console.log(email+" api.js");

    UserController.getUserByEmail(id, email, defaultResponse(req, res));
