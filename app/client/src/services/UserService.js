angular.module('reg')
  ...
  function($http, Session){
    ...
    return {
      ...
      updateIdea: function(id, idea){
        return $http.put(base + id + '/idea', {
          idea: idea
        });
      },


      updateConfirmation: function(id, idea){
      ...
      setTeamName:function(email,teamname){
        return $http.put(base + Session.getUserId() + '/setteam', {
      ...
      getMyTeammates: function(id,teamname){
        return $http.get(base + id + '/team',{
          teamname:teamname
        });
      },
      getUserByEmail: function(email){
        console.log(email);
        return $http.put(base + Session.getUserId() + '/userbyemail', {
          email: email
        });
      },
      getIdeas: function(){
        return $http.get(base + Session.getUserId() + '/idea');
      },
      getEmails: function(){
        return $http.get(base + Session.getUserId() + '/email');
      },
