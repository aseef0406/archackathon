...
//const IdeaCtrl = require('../views/idea/ideaCtrl.js');
const ConfirmationCtrl = require('../views/confirmation/confirmationCtrl.js');
//const IdeaSubmitionCtrl = require('../views/ideasubmition/ideasubmitionCtrl.js');
...
angular.module('reg')
  .config([
    ...
    $stateProvider
      ...
      /*.state('app.idea', {
        url: "/idea",
        templateUrl: "views/idea/idea.html",
        controller: 'IdeaCtrl',
        data: {
          requireVerified: true
        },
      ...
      .state('app.ideasubmition', {
        url: "/ideasubmition",
        templateUrl: "views/ideasubmition/ideasubmition.html",
        controller: 'IdeasubmitionCtrl',
        data: {
          requireVerified: true
        },
        resolve: {
